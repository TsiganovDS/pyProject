...
path = os.path.join(os.path.dirname(__file__), "..", "logs", "utils.log")
...
def setup_utils_logger() -> logging.Logger:
    ...
    utils_handler = logging.FileHandler(path, mode="w", encoding="utf-8")
...
utils_logger.info(loadtrfrom_json(file_path))
