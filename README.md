...
## Модуль utils.py
### loadtrfrom_json: Bозвращает список словарей с данными о финансовых транзакциях.
...
### filter_transactions: Функция для фильтрации списка словарей с операциями на основе строки поиска.
### count_operations_by_category: Возвращает словарь, в котором ключи — это названия категорий, а значения — это количество операций в каждой категории.
### Модуль Main: 
...
## Логирование 
### Добавлено ведение логов для модулей utils.py и masks.py.
